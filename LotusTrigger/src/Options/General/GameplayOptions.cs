...
public class GameplayOptions: LotusGameplayOptions
{
    public static GameplayOptions Instance = null!;
    ...
    public override float GetFirstKillCooldown(PlayerControl player)
    {
    ...
    public GameplayOptions()
    {
        ...
        AllOptions.Add(Builder("Modifier Text Mode")
            ...
            .BindInt(i => GeneralOptions.GameplayOptions.ModifierTextMode = (ModifierTextMode)i)
            .BuildAndRegister());
