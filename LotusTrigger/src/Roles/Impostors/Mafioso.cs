...
using static LotusTrigger.Roles.Impostors.Mafioso.MafiaTranslations;
using static LotusTrigger.Roles.Impostors.Mafioso.MafiaTranslations.MafiaOptionTranslations;
