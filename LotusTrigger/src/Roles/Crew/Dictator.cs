...
using static LotusTrigger.Roles.Crew.Dictator.DictatorTranslations;
using static LotusTrigger.Roles.Crew.Dictator.DictatorTranslations.DictatorOptionTranslations;
