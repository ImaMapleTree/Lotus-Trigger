...
public class Sheriff : Crewmate
{
    ...
    private DynamicRoleOptionBuilder dynamicRoleOptionBuilder;
    ...
    public Sheriff()
    {
        dynamicRoleOptionBuilder = new(new List<DynamicOptionPredicate>
        {
            ...
            new(r => r.Faction is Lotus.Factions.Impostors.Madmates, "Madmates Settings", TranslationUtil.Colorize(SheriffTranslations.MadmateSetting, ModConstants.Palette.MadmateColor))
        }, r => Relationship(r) is not Relation.FullAllies);
    }
