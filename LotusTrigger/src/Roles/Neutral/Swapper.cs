...
using static LotusTrigger.Roles.Neutral.Swapper.SwapperTranslations;
...
public class Swapper : Crewmate
{
    ...
    private ChatHandler CHandler() => Lotus.Chat.ChatHandler.Of(title: RoleColor.Colorize(SwapperAbility)).LeftAlign();
    ...
    protected override AbstractBaseRole.RoleModifier Modify(AbstractBaseRole.RoleModifier roleModifier) => base.Modify(roleModifier).RoleColor("#66E666");
